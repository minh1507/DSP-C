...
class GCNVulnerabilityDetector(nn.Module):
    
    def __init__(self, num_features=100, hidden_dim=64, num_layers=3, num_classes=2, dropout=0.3):
        super(GCNVulnerabilityDetector, self).__init__()
...
def create_gcn_model(num_features=100, hidden_dim=64, num_layers=3, num_classes=2, dropout=0.3):
    return GCNVulnerabilityDetector(
